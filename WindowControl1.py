...
if __name__ == "__main__":
    ...
    file = open('DouyuCode.txt', 'r', encoding='utf8')

    for line in file:
        line = line.replace("\n", "")
        print(line)
        ListCode.append(line)
        # ...
        pyautogui.click(2343, 137)
        time.sleep(1)
        # 激活码
        pyautogui.click(2148, 386)
        time.sleep(1)
        # 输入框
        pyautogui.click(742, 700)
        time.sleep(1)
        pyautogui.typewrite(line)
        time.sleep(1)
        # 确定
        pyautogui.click(1526, 949)
        time.sleep(1)
        keyboard.press('Esc')
        time.sleep(1)
        keyboard.release('Esc')
